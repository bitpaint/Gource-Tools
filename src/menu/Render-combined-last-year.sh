...
gource _combined.txt --stop-at-end --loop-delay-seconds 10  --user-image-dir ../avatars/converted -1920x1080  --start-date "$LASTYEAR"  --file-idle-time 0 -r 30 --seconds-per-day "0.164" --padding 1.5 -a 0.5 --hide "progress,mouse,filenames,root,dirnames" 	--bloom-intensity 0.4   --user-font-size 20 -o - | ffmpeg -y -r 30 -f image2pipe -vcodec ppm -i - -vcodec libx264 -preset veryfast -pix_fmt yuv420p -crf 1 -threads 0 -bf 0 ../../renders/gource.mp4
